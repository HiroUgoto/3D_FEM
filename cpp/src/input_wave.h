namespace input_wave {
  ...
  Eigen::VectorXd
    diff_gauss(const Eigen::VectorXd tim, const double fp, const double tp, const double amp);
  Eigen::VectorXd
    gauss(const Eigen::VectorXd tim, const double fp, const double tp, const double amp);
  Eigen::VectorXd
